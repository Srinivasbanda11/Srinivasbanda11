...
5+ years of DevOps experience building scalable cloud infrastructure on **AWS** and **Azure**  
Specialized in **Kubernetes**, **Terraform**, **Docker**, and **DevSecOps** practices
...
![ARM](https://img.shields.io/badge/ARM_Templates-0078D4?style=for-the-badge&logo=microsoftazure&logoColor=white)
...
- ✅ Reduced environment build time by **60%** with Terraform
- ✅ Improved deployment frequency by **45%** with Jenkins & GitHub Actions
...
- ✅ Reduced setup time by **55%** on Azure AKS
- ✅ Decreased CVEs by **45%** with Trivy scanning
- ✅ Built reusable Terraform modules for 12 environments

**Infrastructure Engineer** @ Allscripts *(Nov 2020 - Dec 2022)*
- ✅ Improved build reliability by **40%** with Jenkins
- ✅ Managed HIPAA-compliant AWS infrastructure
- ✅ Automated DR workflows with RDS snapshots
...
![Azure](https://img.shields.io/badge/Azure-Administrator_(AZ--104)-0078D4?style=for-the-badge&logo=microsoftazure&logoColor=white)
![CKA](https://img.shields.io/badge/Kubernetes-CKA-326CE5?style=for-the-badge&logo=kubernetes&logoColor=white)
